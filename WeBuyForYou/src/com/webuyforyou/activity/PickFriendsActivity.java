...
public class PickFriendsActivity extends FragmentActivity {
		...
		friendPickerFragment
				.setOnDoneButtonClickedListener(new PickerFragment.OnDoneButtonClickedListener() {
					...
					public void onDoneButtonClicked(PickerFragment<?> fragment) {
						...
						List<GraphUser> graphUsers = friendPickerFragment
								.getSelection();
						for (GraphUser graphUser : graphUsers) {
							String bday = graphUser.getBirthday();
							String fName = graphUser.getFirstName();

							Log.d(TAG, "bday :" + bday + fName);
						}
	...
	protected void onStart() {
		super.onStart();
		try {
			// FriendPickerApplication application = (FriendPickerApplication)
			// getApplication();
